...
public class DeviceListActivity extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Typeface tf = Typeface.createFromAsset(getAssets(), "font/NanumBarunGothicBold.ttf");
        scanButton.setTypeface(tf,Typeface.NORMAL);
...
//	}
    ...
    private void doDiscovery() {
        if (D) CarLLog.d(TAG, "doDiscovery()");

        // Indicate scanning in the title
        /*setProgressBarIndeterminateVisibility(true);
        setTitle(*//*R.string.scanning*//*"기기 스캔 중");*/
    ...
    private OnItemClickListener mDeviceClickListener = new OnItemClickListener() {
        public void onItemClick(AdapterView<?> av, View v, int arg2, long arg3) {
            ...
            MainApplication.setmObdMacAddress(getCutMacAddress(address));
